      ...
      <div class="content-1">
        ...
        <div class="content">
            ...
            <div class="bt" style="margin-top: 20px;width: 500px;display: flex;justify-content: flex-end;">
                <input type="submit" value="Approved" class="btn btn-info" style="color:white;">
                <input type="submit" value="Edit" class="btn btn-info" style="color:white;">
                <input type="submit" value="Reject" class="btn btn-info" style="color:white;">
            </div>
        </div>
      </div>
