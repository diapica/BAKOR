...
$sql = "insert into tbregistrasi (username,namaMandarin,namaIndonesia,jenisKelamin,tempatLahir,tanggalLahir,pendidikanTerakhir,alamat,email,noWA,pekerjaan,tingkatan,waktuBelajar,pasFoto,identitasDiri,ijazah,hsk) values('$username','$mandarin','$indonesia','$jenisKelamin','$tempatLahir','$tanggalLahir','$pendidikanTerakhir','$alamat','$email','$no','$pekerjaan','$tingkatan','$waktuBelajar','$target_foto','$target_ktp','$target_ijazah','$target_hsk')";
